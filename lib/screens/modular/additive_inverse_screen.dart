...
class AdditiveInverseScreen extends StatefulWidget {
  const AdditiveInverseScreen({super.key});

  @override
  State<AdditiveInverseScreen> createState() => _AdditiveInverseScreenState();
}

class _AdditiveInverseScreenState extends State<AdditiveInverseScreen> {
  ...
  void _calculate() {
    if (_formKey.currentState!.validate()) {
      try {
        ...
        // Calcular el inverso aditivo: -a mod n
...
''';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Inverso Aditivo'),
